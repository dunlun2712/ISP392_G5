    ...
    <body>
        <form action="login" method="post" class="form-signup">
            <div id="logreg-forms">
                ...
                <input name="newEmail" type="text" id="user-name" class="form-control" placeholder="User name" required="" autofocus="">
                <input name="acc_pass" type="password" id="user-pass" class="form-control" placeholder="Password" required="" autofocus="">
