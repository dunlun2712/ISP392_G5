...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" integrity="sha512-xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" crossorigin="anonymous" />
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="my-5 d-flex justify-content-between align-items-center">
                            <h3>My Profile</h3>
                            <button type="submit" class="btn btn-secondary" style="font-weight: bold;" name="update" value="homepage">
