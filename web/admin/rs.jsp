    ...
    <body>
       <div class="sidebar">
        ...
        <div class="main-content">
            <div class="container"><div class="header">Update electricity numbers</div><br>
               
                    <div class="buttons">
                        <button class="import-btn" onclick="location.href = 'test.jsp'">Import Data</button>
                    </div>
