...
<html lang="en">
    ...
    <body>
        <div class="sidebar">
            ...
            <a href="${pageContext.request.contextPath}/admin?type=viewbiketickets">View Bike Tickets</a>
        ...
        <div class="content">
            ...
            <!-- View Bus Tickets Section -->
            <c:if test="${param.type == 'viewbustickets'}">
                <h2>Bus Ticket Registrations</h2>
                <table class="table table-bordered mt-4">
                    ...
                    <tbody>
                        <c:forEach var="ticket" items="${bikeTickets}">
                            <tr>
                                <td>${ticket.id}</td>
