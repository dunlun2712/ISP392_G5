                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <div class="breadcrumb__text" style="color: black;font-size: 24px;font-weight: bold;line-height: 1.5;">
                            <h1 style="color: black;font-size: 75px;font-weight: bold;"></h1>
                        ...
                        <div class="bg-secondary-soft px-4 py-5 rounded">
                            <div class="row g-3">
                                <div class="container mt-5">
                                    <h1 style="color: black; font-size: 5.2rem">List Request</h1>
                                    <br>
                                            ...
                                            <c:forEach var="request" items="${requests}">
                                                <tr style="background-color: #ffffff;">
                                                    ...
                                                    <td>
                                                        ...
                                                        <!-- Delete --><c:if test="${request.request_status == null}">
