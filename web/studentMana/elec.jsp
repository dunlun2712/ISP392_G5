...
.search-select:focus {
    ...
    <body>
        ...
        <div class="content">
                ...
                <div class="header">Update electricity numbers</div>
                <br>
                <div class="buttons">
                    <button class="import-btn" onclick="location.href = 'admin/readEl.jsp'">Import Data</button>
                    <!--                <button class="calculate-btn" onclick="calculateElectricityWater()">Recalculate the Room's Electricity and Water</button>-->
                </div>
                  <br>
                <form class="filter" action="searchServlet">
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th>Creation Date</th>
                            <th>Electric Meter Reading Date</th>
                            <th>Month</th>
                            <th>Meter Number</th>
                            <th>Consumption</th>
                            <th>Old Number</th>
                    ...
                    <tbody>
                        <c:forEach var="data" items="${data}">
                            <tr>
                                ...
                                <td>${data.getOld_number()}</td>
                                <td>${data.getNew_number()}</td>                            
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
