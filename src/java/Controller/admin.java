    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (type) {
            ...
            case "viewmanager":
                ...
                ArrayList<Account> account = acc.getAllAcc();
...
//        
        ...
        for (Account account : accounts) {
            String newStatus = request.getParameter("status_" + account.getEmail());
            if (newStatus != null && !newStatus.equals(account.getStatus())) {
                accDao.updateAcc(account.getEmail(), account.getRole(), newStatus);
            }
        }
