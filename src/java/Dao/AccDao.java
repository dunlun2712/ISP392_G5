...
//khai bao thanh phan xu ly database
    ...
    public void updatePass(String newPassword, String email) {
        try {
            String strSQL = "update Users set acc_pass=? WHERE acc_email = ?";
            stm = cnn.prepareStatement(strSQL);
    ...
    public void updatePassAcc(String newPassword, String email) {
        try {
            String strSQL = "update Account set acc_pass=? WHERE acc_email = ?";
            stm = cnn.prepareStatement(strSQL);
